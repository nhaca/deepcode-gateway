...
// DeepCode (auto) = 1 credit/request
// Provider-specific (user selects manually) = 50 credits/request
const MODEL_CREDIT_COST = {
  // DeepCode auto = 1 credit
  'auto': 1,
  // All provider-specific models = 50 credits
  'llama-3.3-70b-versatile': 50, 'llama-3.1-8b-instant': 50,
  'llama-3.3-70b': 50, 'llama-3.1-8b': 50, 'llama-3.1-70b-versatile': 50,
  'llama-3.1-70b': 50, 'gemma2-9b-it': 50, 'mixtral-8x7b-32768': 50,
  'DeepSeek-V3-0324': 50, 'Llama-3.3-70B': 50, 'Llama-3.1-8B': 50, 'Llama-3.1-70B': 50,
  'meta/llama-3.3-70b-instruct': 50, 'meta/llama-3.1-8b-instruct': 50, 'meta/llama-3.1-70b-instruct': 50,
  'deepseek-ai/deepseek-r1': 50, 'mistralai/mistral-large-2-instruct': 50,
  'openrouter:meta-llama/llama-3.3-70b-instruct': 50, 'openrouter:meta-llama/llama-3.1-8b-instruct': 50,
  'openrouter:meta-llama/llama-3.1-70b-instruct': 50, 'openrouter:mistralai/mistral-7b-instruct': 50,
  'openrouter:qwen/qwen-2.5-72b-instruct': 50, 'openrouter:google/gemma-2-9b-it': 50,
  'openrouter:anthropic/claude-3.5-sonnet': 50, 'openrouter:openai/gpt-4o-mini': 50,
  'openrouter:openai/gpt-4o': 50, 'openrouter:google/gemini-2.0-flash-001': 50,
  'mistral-small-latest': 50, 'mistral-large-latest': 50, 'codestral-latest': 50, 'open-mistral-nemo': 50,
  'command-r': 50, 'command-r-plus': 50, 'command-r-light': 50,
  'venice-uncensored': 50,
  'llm7:meta-llama/llama-3.3-70b-instruct': 50, 'llm7:meta-llama/llama-3.1-8b-instruct': 50,
  'huggingface:Qwen/Qwen3-8B': 50, 'huggingface:meta-llama/Llama-3.3-70B-Instruct': 50,
  'huggingface:meta-llama/Llama-3.1-8B-Instruct': 50,
  'kira-3.5-flash': 50, 'kira-2.5-pro': 50,
  'ovhcloud:meta-llama/Meta-Llama-3.3-70B-Instruct': 50, 'ovhcloud:meta-llama/Meta-Llama-3.1-8B-Instruct': 50,
  'gemini-2.5-flash': 50, 'gemini-2.0-flash': 50, 'gemini-1.5-flash': 50, 'gemini-1.5-pro': 50,
  // Mid-tier (provider-specific)
  'z-ai/glm-5.1': 50, 'z-ai/glm-4.7-flash-free': 50, 'stepfun/step-3.7-flash-free': 50,
  'z-ai/glm-5.2-free': 50,
  // Premium (provider-specific)
  'claude-opus-4-8': 50, 'claude-sonnet-4': 50, 'gpt-5': 50,
  'gpt-4.1': 50, 'glm-5.1': 50,
  'llama-4-maverick': 50, 'qwen-3-235b': 50,
  // GitHub Models (user's own token)
  'github:gpt-4o': 50, 'github:gpt-4o-mini': 50, 'github:gpt-4.1': 50, 'github:gpt-4.1-mini': 50,
  'github:o3-mini': 50, 'github:Llama-3.3-70B-Instruct': 50, 'github:Llama-3.1-405B-Instruct': 50,
  'github:Llama-3.1-8B-Instruct': 50, 'github:Llama-4-Scout-17B-16E-Instruct': 50,
  'github:Llama-4-Maverick-17B-128E-Instruct': 50, 'github:Mistral-Large-2411': 50,
  'github:Mistral-Small-2501': 50, 'github:Phi-4': 50, 'github:Phi-4-mini-instruct': 50,
  'github:DeepSeek-R1': 50, 'github:DeepSeek-V3-0324': 50,
  'github:Cohere-C4AI-Command-R-08-2024': 50, 'github:Cohere-C4AI-Command-R-Plus-08-2024': 50,
};
