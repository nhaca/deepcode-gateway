...
if (!GATEWAY_SECRET) throw new Error('FATAL: GATEWAY_SECRET env var required');
...
const MODEL_CREDIT_COST = {
  ...
  'llama-3.3-70b': 1, 'llama-3.1-8b': 1, 'deepseek-chat': 1,
  'deepseek-ai/deepseek-v3-0324': 1, 'mistral-small-latest': 1,
  ...
  'z-ai/glm-5.2-free': 5, 'codestral-latest': 5, 'command-r-plus': 5,
  // Premium
  'claude-opus-4-8': 20, 'claude-sonnet-4': 20, 'gpt-5': 20,
  'gpt-4.1': 15, 'deepseek-v4': 15, 'glm-5.1': 15,
