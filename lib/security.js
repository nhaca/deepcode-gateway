...
const MODEL_CREDIT_COST = {
  ...
  'llama-3.3-70b': 1, 'llama-3.1-8b': 1,
  'DeepSeek-V3-0324': 1, 'mistral-small-latest': 1,
  'command-r': 1, 'venice-uncensored': 1, 'kira-3.5-flash': 1,
  'gemini-2.5-flash': 1, 'Qwen/Qwen3-8B': 1,
  'meta/llama-3.3-70b-instruct': 1, 'codestral-latest': 1,
  'command-r-plus': 1, 'meta/llama/llama-3.3-70b-instruct': 1,
  'meta-llama/Meta-Llama-3.3-70B-Instruct': 1,
  'meta-llama/llama-3.1-8b-instruct': 1, 'mistralai/mistral-7b-instruct': 1,
  'qwen/qwen-2.5-72b-instruct': 1, 'google/gemma-2-9b-it': 1,
  // Mid-tier
